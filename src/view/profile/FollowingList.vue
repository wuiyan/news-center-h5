<template>
  <div class="following-page">
    ...
    <div class="content">
      ...
      <div class="empty-state" v-if="followingList.length === 0 && !isLoading">
      ...
      <div v-else class="user-list">
        <div v-for="user in followingList" :key="user.id" class="user-item">
          ...
          <div class="action-btn unfollow-btn" @click="handleUnfollow(user.id)">
            取消关注
          </div>
        </div>
      </div>
...
import { getFollowingList, followUser } from "../../api/user.js";
